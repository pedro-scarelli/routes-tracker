...
export class Map {
  ...
  async addRouteWithIcons(routeOptions: {
    routeId: string
    startMarkerOptions: Omit<google.maps.marker.AdvancedMarkerElementOptions, 'icon'>
    endMarkerOptions: Omit<google.maps.marker.AdvancedMarkerElementOptions, 'icon'>
    carMarkerOptions: Omit<google.maps.marker.AdvancedMarkerElementOptions, 'icon'>
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    directionsResponseData?: DirectionsResponseData & { request: any }
  }) {
...
export class MapRoute {
  ...
  constructor(options: {
    ...
    this.startMarker = new google.maps.marker.AdvancedMarkerElement(startMarkerOptions)
    this.endMarker = new google.maps.marker.AdvancedMarkerElement(endMarkerOptions)
    this.carMarker = new google.maps.marker.AdvancedMarkerElement(carMarkerOptions)
  ...
  async calculateRoute(
    ...
    if (directionsResponseData) {
      const directionsResult = convertDirectionsResponseToDirectionsResult(directionsResponseData)
